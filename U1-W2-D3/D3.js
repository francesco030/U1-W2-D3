...
//{
  //case "blue": eyeColor.blue.push (starWarsCharacters[i])
    ...
    //break;
    //case "blue-gray": eyeColor.blueGray.push(starWarsCharacters[i])
    //break;
    //default:
      //break;
 //}
...
*/
 ...
 // )
  ...
  //  console.log( 
 // ' Ship is half loaded')
 // if ( starWarsCharacters[i].mass > 700 || starWarsCharacters[i].mass < 900)
//  console.log (
//' Warning, ship is over 700')
//if (starWarsCharacters[i].mass > 900 || starWarsCharacters[i].mass < 1000)
 //  console.log (
